...
LORA_MODELS=(
    "https://civitai.com/api/download/models/16677?type=Model&format=SafeTensor&size=full&fp=fp16" #Cute Girl Mix4
    "https://civitai.com/api/download/models/87153?type=Model&format=SafeTensor" #More Details
